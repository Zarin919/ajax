  ...
  if ($_SERVER['REQUEST_METHOD'] === "POST")
  {
            ...
            $Password = $_POST['Password'];
             ...
             if(empty($Firstname) or strlen($Firstname) > 20)
               {
                  $FirstnameErr = "Can not be empty or > 20 Character.";
                  $isValid = false;
               }
             if(empty($Lastname) or strlen($Lastname) > 20)
               {
                  $LastnameErr = "Can not be empty or > 20 Character. Character.";
                  $isValid = false;
               }
             if(empty($Gender) or strlen($Gender) > 6)
               {
                  $GenderErr = "Gender can not be empty or > 6 Character.";
                  $isValid = false;
               }
             if(empty($DOB))
               {
             ...
             if(strlen($Present_Address) > 150)
               {
                  $Present_AddressErr = "presentaddress can not be longer than 150 Character.";
                  $isValid = false;
               }
             if(strlen($Permanent_Address) > 150)
               {
                  $Permanent_AddressErr = "Permanentaddress can not longer than 150 Character > 150 Character.";
                  $isValid = false;
               }
             if(strlen($Phone) > 11)
               {
                  $PhoneErr = "phone can not be > 11 Character.";
                  $isValid = false;
               }
             ...
             if(empty($Username) or strlen($Username) > 20)
               {
                  $UsernameErr = "Username can not be empty or > 20 Character.";
                  $isValid = false;
               }
    ...
    <form action="<?php echo htmlspecialchars(($_SERVER['PHP_SELF'])); ?>" method = "POST">
      ...
      <table>
       <tbody>
         ...
         <tr>
           <td><label for="fname">First Name:<span style="color: blue"><?php echo "*"; ?></span></label></td>
           <td><input type="text" id="fname" name="Firstname" value="<?php echo $Firstname ?>">
           <span style="color: blue"> <?php echo $FirstnameErr; ?> </span></td>
        </tr>

         <tr>
           <td><label for="lname">Last name:<span style="color: blue"><?php echo "*"; ?></span> </label></td>
           <td><input type="text" id="lname" name="Lastname"value="<?php echo $Lastname ?>">
           <span style="color: blue"> <?php echo $LastnameErr; ?> </span></td>
        </tr>


           <tr>
           <td> Select Gender:<span style="color: blue"><?php echo "*"; ?></span></td>
          ...
          <span style="color: blue"> <?php echo $GenderErr; ?> </span></td>
           </tr>


         <tr>
           <td><label for="DOB">DOB:<span style="color: blue"><?php echo "*"; ?></span></label></td>
           <td><input type="date" id="DOB" name="DOB"value="<?php echo $DOB ?>">
          <span style="color: blue"> <?php echo $DOBErr; ?> </span></td>
        </tr>

         <tr>
           <td>Religion:<span style="color: blue"><?php echo "*"; ?></td>
           <td>
          ...
          <span style="color: blue"> <?php echo $ReligionErr; ?> </span></td>
       </tr>
      ...
      <fieldset>
        ...
        <table>
           <tbody>
             ...
             <tr>
               <td><label for="phone">phone:<span style="color: blue"></label></span>
               <td><input type="tel" id="phone" name="phone"value="<?php echo $Phone ?>">
               </td>
              </tr>

              <tr>
                <td><label for="Email">Email:<span style="color: blue"><?php echo "*"; ?></span> </label>
                <td><input type="Email" id="Email" name="Email"value="<?php echo $Email ?>">
                <span style="color: blue"> <?php echo $EmailErr; ?> </span></td>
             </tr>
